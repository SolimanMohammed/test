<html dir="rtl">
  <head>
    <title>Prophetic Medicine Details</title>
    <meta charset="UTF-8" />
    ...
    <section class="main"> 
      <div class="content">
        <?php
          ...
          $Check_Medicine=mysqli_query($DB_Conn,"select * from medicine where ID=$id") or die(mysqli_error($DB_Conn));
        ...
        <?php 
                ...
                echo "<span>".'الوصف:'."</span>".$Result['Description']."</br>"."</br>";
                echo "<span>".'الاستخدامات:'."</span>".$Result['Uses']."</br>"."</br>";
                echo "<span>".'الدليل:'."</span>".$Result['Evidence']."</br>"."</br>";
